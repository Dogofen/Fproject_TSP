...
MEM_0 := nios2_c_tightly_coupled_data_memory
$(MEM_0)_NAME := tightly_coupled_data_memory
...
$(MEM_0)_HIERARCHICAL_PATH := tightly_coupled_data_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: tightly_coupled_data_memory
tightly_coupled_data_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: tightly_coupled_instruction_memory
MEM_1 := nios2_c_tightly_coupled_instruction_memory
$(MEM_1)_NAME := tightly_coupled_instruction_memory
...
$(MEM_1)_END := 0x0003387f
$(MEM_1)_HIERARCHICAL_PATH := tightly_coupled_instruction_memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: tightly_coupled_instruction_memory
tightly_coupled_instruction_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
